...
begin_fields = [
    ...
    [
        sg.Text('Продолжительность эксперимента в месяцах (6-24)', size=SIZE_TEXT, font=SIZE_FONT),
        sg.Column([
        [sg.InputText(key='m', default_text='24', font=INPUT_FONT, size=SIZE_INPUT, enable_events=INPUT_EVENTS)],
        [sg.Text('Только целое число', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='m.num')],
        [sg.Text('Значение >= 6 и <= 24', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='m.seq')]])
    ],
    [
        sg.Text('Продолжительность начальных условий в месяцах (1-24)', size=SIZE_TEXT, font=SIZE_FONT),
        sg.Column([
        [sg.InputText(key='duration', default_text='12', font=INPUT_FONT, size=SIZE_INPUT, enable_events=INPUT_EVENTS)],
        [sg.Text('Только целое число', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='duration.num')],
    ...
    [
        ...
        [sg.Text('Только целое число', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='tax.num')],
    ...
    [
        sg.Text('Начальный капитал в у.е. (>= 1)', size=SIZE_TEXT, font=SIZE_FONT),
        sg.Column([
        [sg.InputText(key='capital', default_text='100000', font=INPUT_FONT, size=SIZE_INPUT, enable_events=INPUT_EVENTS)],
        [sg.Text('Только целое число', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='capital.num')],
        [sg.Text('Значение >= 1', font=INPUT_FONT, visible=IS_VISIBLE, text_color='#960101', background_color='#FF9696', size=SIZE_INPUT, key='capital.seq')]])
    ],
